...
export default function() {
    ...
    var lives: any;
    var enemyBullet: any;
    var enemyBullets: any;
    var firingTimer = 0;
    var stateText: any;
    var livingEnemies:any[] = [];
    ...
    function setupInvader (invader:any) {
    ...
    function collisionHandler (bullet:any, alien:any) {
    ...
    function enemyHitsPlayer (player:any, bullet:any) {
    ...
    function enemyFires () {
        ...
        aliens.forEachAlive(function(alien:any){
